<%@ Page Title="" Language="C#" MasterPageFile="~/OrganizationSide/Organization.Master" AutoEventWireup="true" CodeBehind="OrgAddProj.aspx.cs" Inherits="FInalProject.WebForm9" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        ...
        <table style="margin-right: 0px">
            ...
            <tr>
                <td style="width: 262px">
                    Swap/Trade/Compensation):</td>
                <td>
                    <asp:CheckBox ID="cbAssets" runat="server" Text="Swap/Trade Assets (i.e. Free Venue, Provide goods Instruments, Use of Vehicle, etc.):" />
                    <br />
                    <asp:TextBox ID="tbAsset" runat="server"></asp:TextBox>
                    <br />
                    <br />
                    <asp:CheckBox ID="cbBudget" runat="server" Text="Salary / Payment Budget $:" />
                    <br />
